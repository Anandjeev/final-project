...
const SpaceCard = ({ space, onBooking, setSelectedSpace, setShowDeleteModal }) => {
    ...
    return (
        <div className='card black-text'>
            ...
            {!is_booked ?
                <>
                    <button className='btn btn-outline-warning my-3 mx-3 ' onClick={onBooking} disabled={user?.type === "owner"} >Book</button>
                    <div className='posted-by px-4 py-2 '>
                    </div>
                </>
                :
                <>
                    <button className='btn btn-secondary my-3 mx-3' disabled>Already Booked!</button>
                    <div className='posted-by px-4 py-2'>
                    </div>
                </>}
        </div>
