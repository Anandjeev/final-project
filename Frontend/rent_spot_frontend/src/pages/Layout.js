    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container-fluid">
                <Link className="navbar-brand" to="/">CarSwiftRentals</Link>
        ...
        <li className="nav-item">
                            ...
                            {user ?
                                <>
                                    <li className="nav-item ms-2">
                                        <Link className="nav-link" to='/profile'><div className="user-circle">{user?.name && user?.name[0]}</div></Link>
                                    </li>
                                    <li className="nav-item ms-2">
                                ...
                                :
                                <li className="nav-item ms-2 nav-item-with-margin">
            ...
            <footer className="container-fluid p-5 mt-5">
                <div className="row">
                    ...
                    <p>Copyright &copy; <span id="currentYear">2024</span> by CarSwiftRentals<script>document.getElementById("currentYear").innerHTML = new Date().getFullYear();</script></p>
                    </div>
                    <div className="col-md-4">
                    </div>
